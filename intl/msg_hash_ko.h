...
MSG_HASH(
      ...
      "인수가 제공되지 않았으며 내장된 메뉴가 없습니다. 도움말을 표시하고 있습니다."
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "구현이 다릅니다. 동일한 버전의 RetroArch 및 코어를 사용하고 있는지 확인하십시오."
      )
MSG_HASH(
      MSG_NETPLAY_ENDIAN_DEPENDENT,
      "본 코어는 해당 시스템에서 아키텍처간 넷플레이를 지원하지 않습니다."
      )
MSG_HASH(
      MSG_NETPLAY_PLATFORM_DEPENDENT,
      "본 코어는 아키텍처간 넷플레이를 지원하지 않습니다."
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "하드웨어 렌더링된 코어에 고유한 컨텍스트를 제공합니다. 프레임간에 하드웨어 상태를 변경할 필요가 없습니다."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_MENU_SETTINGS,
      "메뉴 화면의 모양과 관련된 설정을 변경합니다."
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "죄송합니다, 구현되지 않았습니다: 콘텐츠를 요구하지 않는 코어는 넷플레이에 참여할 수 없습니다."
      )
MSG_HASH(
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_FBO_SUPPORT,
      "OpenGL/Direct3D 텍스처 렌더링 (멀티 패스 셰이더) 지원")
...
MSG_HASH(MENU_ENUM_SUBLABEL_CHEEVOS_ENABLE,
      "도전 과제를 활성화 또는 비활성화합니다. 자세한 정보는 http://retroachievements.org을(를) 방문하십시오.")
MSG_HASH(MENU_ENUM_SUBLABEL_CHEEVOS_TEST_UNOFFICIAL,
      "비공식 도전 과제 및 테스트 목적의 베타 기능을 활성화 또는 비활성화합니다.")
MSG_HASH(MENU_ENUM_SUBLABEL_CHEEVOS_HARDCORE_MODE_ENABLE,
      "모든 게임에 대해 상태 저장, 치트, 되감기, 빨리 감기, 일시 중지 및 슬로우 모션을 활성화 또는 비활성화합니다.")
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_LATENCY,
      "밀리초 단위의 오디오 지연 시간을 설정합니다. 오디오 드라이버가 주어진 지연 시간을 사용 할 수 없는 경우 무시될 수 있습니다.")
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_MUTE,
      "오디오를 음소거/음소거 해제합니다.")
MSG_HASH(
      MENU_ENUM_SUBLABEL_AUDIO_RATE_CONTROL_DELTA,
      "오디오와 비디오 동기화시 타이밍 불완전성을 완화합니다. 사용 할 수 없는 경우 정상적인 동기화가 불가능합니다."
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "RetroArch에서 지원하는 최대 사용자 수를 설정합니다."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_INPUT_POLL_TYPE_BEHAVIOR,
      "RetroArch 내부에서 입력 폴링이 수행되는 방식에 영향을 줍니다. '빠르게' 또는 '느리게'로 설정하면 구성에 따라 지연 시간이 줄어들 수 있습니다."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_INPUT_ALL_USERS_CONTROL_MENU,
      "모든 사용자가 메뉴를 제어할 수 있도록 합니다. 사용하지 않는 경우 첫 번째 사용자만 메뉴를 제어할 수 있습니다."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_AUDIO_VOLUME,
      "dB 단위의 오디오 음량입니다. 0 dB 은 표준 음량이며, 게인은 적용되지 않습니다."
      )
MSG_HASH(
   MENU_ENUM_SUBLABEL_AUDIO_SYNC,
   "오디오를 동기화합니다. 권장 설정입니다."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "오디오 입력 속도의 최대 변화입니다. 부정확한 오디오 피치를 희생하여 NTSC 디스플레이에서 PAL 코어를 실행하는 경우, 값을 증가시켜 타이밍에 큰 변화를 줄 수 있습니다."
   )
MSG_HASH(
   MSG_FAILED,
   "failed"
...
MSG_HASH(MENU_ENUM_SUBLABEL_PAUSE_NONACTIVE,
      "창 포커스가 해제되면 게임 플레이를 일시 중지합니다.")
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_DISABLE_COMPOSITION,
      "컴포지션을 활성화 또는 비활성화합니다. Windows에만 해당됩니다.")
MSG_HASH(MENU_ENUM_SUBLABEL_HISTORY_LIST_ENABLE,
      "게임, 사진, 음악 및 비디오의 최근 재생 목록을 활성화 또는 비활성화합니다.")
MSG_HASH(MENU_ENUM_SUBLABEL_CONTENT_HISTORY_SIZE,
      "게임, 사진, 음악 및 비디오에 대한 최근 재생 목록의 항목 수를 제한합니다.")
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_UNIFIED_MENU_CONTROLS,
      "통합 메뉴 제어")
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_UNIFIED_MENU_CONTROLS,
      "메뉴와 게임 모두에 동일한 제어를 사용합니다. 키보드에 해당됩니다.")
